/**
 * @description: gruntfile for node boilerplate
...
module.exports = function (grunt) {
  ...
  grunt.initConfig({
    ...
    compress: {
      ...
      cache: {
        options: {
          archive: backupsDestination + 'cache.tar.gz',
        },
        expand: true,
        cwd: './cache/',
        src: includeAllFiles,
  ...
  const myTasksStatus = ['compress: main | github | cache | src | tests | tmp'];
  ...
  grunt.registerTask('default', () => {
   ...
   // task resume
    getTaskResume('== NODE BOILERPLATE TASKS ==', myTasksNames, myTasksStatus, 'yellow');
  });
};
